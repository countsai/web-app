// Forward Deployed Engineering Certificate — two-panel layout matching GenAI visual system.
...
export function FDECertificate({ cert, qrSvg, logoDataUrl, signatureDataUrl }: Props) {
  const meta = CERT_META["fde"];
  const programDesc =
    "An intensive program in forward-deployed engineering: designing, building, and operating AI systems directly with clients in production environments.";

  const satinBg = [
    "linear-gradient(125deg, rgba(255,255,255,0.22) 0%, rgba(255,255,255,0.07) 22%, transparent 42%, rgba(127,181,212,0.22) 57%, transparent 72%, rgba(255,255,255,0.18) 88%, rgba(127,181,212,0.06) 100%)",
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Divider */}
        <div style={{ width: "36px", height: "1px", background: "rgba(127,181,212,0.40)", margin: "14px 0 0" }} />
      ...
      <div
        style={{
          ...
          backgroundImage: "radial-gradient(circle, rgba(127,181,212,0.18) 1px, transparent 1px)",
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "14px" }}>
          <div>
            <p style={{ margin: "0 0 2px 0", fontSize: "11px", fontWeight: "700", color: "#003d75", letterSpacing: "3.5px" }}>
              {meta.title}
            </p>
            {/* FDE identity tags */}
            <div style={{ display: "flex", gap: "8px" }}>
              {["DESIGN", "BUILD", "DEPLOY", "OPERATE"].map((t) => (
                <span key={t} style={{ fontSize: "6.5px", fontWeight: "700", color: "rgba(0,61,117,0.65)", letterSpacing: "1.8px" }}>
                  {t}
                </span>
              ))}
            </div>
        ...
        >
          ...
          <div style={{ width: "54px", height: "3px", background: "#7fb5d4", margin: "8px 0 14px", borderRadius: "2px" }} />

          <p style={{ margin: "0 0 7px 0", fontSize: "8.5px", fontWeight: "600", color: "#536B73", letterSpacing: "5.5px", textTransform: "uppercase" }}>
            has successfully completed the
          </p>

          <p style={{ margin: "0 0 8px 0", fontSize: "28px", fontWeight: "700", color: "#003d75", textAlign: "center" }}>
            {cert.program_name}
          </p>
            ...
            {[
              ...
              <div key={i} style={{ display: "flex", alignItems: "stretch" }}>
                ...
                <div style={{ textAlign: "center", minWidth: "124px" }}>
                  <p style={{ margin: "0 0 5px 0", fontSize: "8px", fontWeight: "700", color: "#003d75", letterSpacing: "2.5px" }}>
                    {item.label}
                  </p>
        ...
        >
          ...
          <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <svg width="110" height="110" viewBox="0 0 110 110" xmlns="http://www.w3.org/2000/svg">
              ...
              <path id="fdearc" d="M 8 55 a 47 47 0 0 1 94 0 a 47 47 0 0 1 -94 0" fill="none" />
              <text fontSize="5.5" fill="rgba(0,61,117,0.65)" fontWeight="700" letterSpacing="2.8"
                fontFamily="Helvetica Neue, Arial, sans-serif">
                <textPath href="#fdearc" startOffset="3%">
          ...
          >
            ...
            <div style={{ paddingTop: "3px" }}>
              <p style={{ margin: "0 0 5px 0", fontSize: "9px", fontWeight: "700", color: "#003d75", letterSpacing: "2px" }}>
                VERIFY CREDENTIAL
              </p>
              <p style={{ margin: "0 0 3px 0", fontSize: "8.5px", color: "#536B73", lineHeight: "1.45" }}>
                Scan the QR or visit:
              </p>
              <p style={{ margin: "0 0 8px 0", fontSize: "8px", color: "#003d75", fontWeight: "600" }}>
                countsai.com/verify
              </p>
